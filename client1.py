...
if __name__ == "__main__":
    ...
    with open("C2_accuracy.pickle", "wb") as file:
        pickle.dump(accuracy_values, file)

    with open("C2_precision.pickle", "wb") as file:
        pickle.dump(precision_values, file)

    with open("C2_recall.pickle", "wb") as file:
        pickle.dump(recall_values, file)

    with open("C2_f1_score.pickle", "wb") as file:
        pickle.dump(f1_score_values, file)

    with open("C2_auc.pickle", "wb") as file:
        pickle.dump(auc_values, file)

    with open("C2_data_distribution.pickle", "wb") as file:
        pickle.dump(data_distribution_values, file)

    with open("C2_communication_overhead.pickle", "wb") as file:
        pickle.dump(communication_overhead_values, file)

    with open("C2_privacy_metrics.pickle", "wb") as file:
        pickle.dump(privacy_metrics_values, file)

    with open("C2_model_loss.pickle", "wb") as file:
